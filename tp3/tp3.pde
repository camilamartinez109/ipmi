...
void setup() {
  size(800, 400);
  img = loadImage("img.jpg"); // Asegurate de que la imagen esté en la carpeta del sketch
  rectMode(CENTER);
  imageMode(CORNER);
  noLoop();
}
...
// Click para activar el movimiento
void mousePressed() {
  movimientoActivo = true;
}

// Solo si está activado, responde al movimiento
void mouseMoved() {
  if (movimientoActivo) {
